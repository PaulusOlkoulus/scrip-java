...
public class UserServiceImpl implements UserService{
    ...
    @Autowired
    public UserServiceImpl(UserRepository repository, RoleRepository roleRepository, PasswordEncoder passwordEncoder, RoleServiceImpl roleServiceImpl, ModelMapper modelMapper) {
    ...
    public void updateUser(UserDTO user) {
        ...
        user.setRoleList(user.getRoleList().stream()
                .map(role -> roleServiceImpl.getByRole(role.getRole()))
                .collect(Collectors.toSet()));
        if (!Objects.equals(repository.getById(user.getId()).getPassword(), user.getPassword())) {
